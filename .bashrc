...
export DOCUMENTS="$WIN_HOME/Documents"
export DOWNLOADS="$WIN_HOME/Downloads"
export TEMPLATES="$WIN_HOME/Templates"
export PUBLIC="$WIN_HOME/Favorites"
export PRIVATE="$WIN_HOME/OneDrive"
export PICTURES="$WIN_HOME/Pictures"
export MUSIC="$WIN_HOME/Music"
export VIDEOS="$WIN_HOME/Videos"
export PDFS="$DOCUMENTS/PDFS"
export NOTES="$DOCUMENTS/Notes"
export HDD="/mnt/f/PC\ Backup"
...
export WORKSPACES="$WIN_HOME/Workspaces" # container home dirs for mounting
