...
export ZSH_PLUGINS="$REPOS/github.com/zsh_pluggins"
...
source $ZSH_PLUGINS/jq-zsh-plugin/jq.plugin.zsh 2>/dev/null
...
source $SNIPPETS/dirFileHelper	# Directory and file helper
source $SNIPPETS/cheat		# Cheat.sh
source $SNIPPETS/transfersh		# transfersh
source $SNIPPETS/cambinary		# seach in cambridge dictionary
source $SNIPPETS/haste		# hastebin online clipboard
